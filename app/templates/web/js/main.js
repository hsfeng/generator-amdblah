...
require(['jquery', 'underscore', 'backbone', 'domready', 'underscore.string',
	'marionette', 'i18next', 'moment', 'modernizr', 'bootstrap'
], function($, _, Backbone, domReady, underscoreString) {
	'use strict';
	domReady(function() {
